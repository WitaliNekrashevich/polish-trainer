...
function genNominativeIdentity() {
  return cap50([
    ...
    input("Uzupełnij formę mnogą: To są ___ studenci (dobry).", "dobrzy"),
    input("Uzupełnij formę mnogą: To są ___ książki (ciekawy).", "ciekawe"),
